...
async def download_file(file_hash: str, request: Request):
    ...
    # Only count as a new download when it's the initial request (no Range or Range: bytes=0-).
    # 1DM sends 8-16 parallel Range requests for one download — counting each would inflate stats.
