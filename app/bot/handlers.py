...
CHANGES:
  6. Added help_command — replies with full feature guide in Markdown.
"""
import logging
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "Send any file and get an instant shareable link for streaming "
        ...
        "✅ Best for HEVC/x265 files with full audio support\n\n"

        "⚡ *Fastest download — 1DM (Android):*\n"
        "1. Install *1DM* (Internet Download Manager) from Play Store\n"
        "2. Open the link on your phone\n"
        "3. Tap *1DM Download* button on the page\n"
        "✅ Multi-threaded download, up to 5× faster than the browser\n\n"

        "🔄 *How to get a fresh link:*\n"
        "Just forward or resend the same file to this bot — "
        "a new link will be generated instantly.\n\n"
        ...
        "❓ *Having issues?*\n"
        "• If a video has no sound, use VLC instead of the browser player\n"
        "• If a link shows \"expired\", resend the file for a new one\n"
        "• If the download is slow, try the 1DM button on Android",
        parse_mode="Markdown",
    )
