...
BASE_URL  = os.getenv("BASE_URL", "https://demo-production-ff8c.up.railway.app").rstrip("/")
...
MAX_CONCURRENT_DOWNLOADS = int(os.getenv("MAX_CONCURRENT_DOWNLOADS", "16"))  # 1DM uses 8-16 parallel threads
